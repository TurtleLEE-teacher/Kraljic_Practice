      ...
      <div className="min-h-screen bg-slate-50">
        ...
        <div className="max-w-2xl mx-auto px-4 py-6 space-y-5">
          ...
          <div className="space-y-2">
            ...
            <Link
              href="/strategy"
              className="w-full flex items-center justify-center gap-2 py-4 rounded-xl bg-violet-600 text-white text-sm font-bold hover:bg-violet-700 transition-colors shadow-lg"
            >
            ...
            >
              <div className="px-4 py-3">
                ...
                <details className="mt-1.5 group">
                  <summary className="text-[11px] text-gray-400 hover:text-blue-500 cursor-pointer list-none flex items-center gap-1">
                  ...
                  <p className="text-xs text-blue-600 bg-blue-50 rounded-lg px-3 py-2 mt-1 leading-relaxed">
                    {item.hint}
                  </p>
                </details>
              </div>
